...
from PyNS import Log
from PyNS import Survey
import os
import pandas as pd
...
#from PyNS import log  # Assuming log is an instance of a class with the required methods

class Application(tk.Tk):
    
    def __init__(self):
        super().__init__()
        self.title("PyNS Log Viewer")
